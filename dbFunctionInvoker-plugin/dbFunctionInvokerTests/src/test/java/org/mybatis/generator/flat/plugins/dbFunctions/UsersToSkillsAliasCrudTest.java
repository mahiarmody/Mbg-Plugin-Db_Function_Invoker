...
public class UsersToSkillsAliasCrudTest
{
	...
	public void test10SelectByPrimaryKey()
	{
		...
		{
			UsersToSkillsMapper mapper = sqlSession.getMapper(UsersToSkillsMapper.class);
			usrToSkArr[0] = mapper.selectByPrimaryKey(Integer.valueOf(1), Short.valueOf((short)3));
			usrToSkArr[1] = mapper.selectByPrimaryKey(Integer.valueOf(1), Short.valueOf((short)4));
		}
		finally
		{
			sqlSession.close();
	...
	public void test45DeleteByPrimaryKey()
	{
		...
		{
			UsersToSkillsMapper mapper = sqlSession.getMapper(UsersToSkillsMapper.class);
			cnt = mapper.deleteByPrimaryKey(Integer.valueOf(1), Short.valueOf((short)2));
			sqlSession.commit();
		}
		finally
		{
