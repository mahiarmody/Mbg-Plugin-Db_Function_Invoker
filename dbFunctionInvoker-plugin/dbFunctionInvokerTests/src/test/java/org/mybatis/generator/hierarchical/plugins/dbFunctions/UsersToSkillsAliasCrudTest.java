...
public class UsersToSkillsAliasCrudTest
{
	...
	public void test01BothInserts()
	{
		...
		utsSelective.setUserId(Integer.valueOf(1)); //value in hsqldb is mahiar
		utsSelective.setSkillId(Short.valueOf((short)2)); //value in hsqldb is postgresql

		UsersToSkills utsPlain = new UsersToSkills();
		utsPlain.setUserId(Integer.valueOf(1)); //value in hsqldb is mahiar
		utsPlain.setSkillId(Short.valueOf((short)3)); //value in hsqldb is mybatis
